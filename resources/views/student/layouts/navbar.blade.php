<nav class="navbar navbar-expand-lg bg-light fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand" href="{{route("student.home")}}"><img src="{{asset("images/logo.png")}}" width="50" height="50" alt=""><span class="px-1 text-primary">{{__("PROJETS GI")}}</span></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" role="search" method="POST" action="{{route("student.search")}}">
        @csrf
        <input class="form-control me-2" name="word" type="search" placeholder="{{("Rechercher un projet")}}" aria-label="Search">
